...
**********************************************************************
     ...
     1 DF(12)
      ...
      IF (ICONTR(38).EQ.1) THEN                                         GDH0195
         ICONTR(38)=2                                                   GDH0195
         DEBUG=(IINTER.NE.0)                                            DJG0995
         DEBUG1=(IDEBUG.NE.0.AND.DEBUG)                                 DJG0995
         DO 10 I=1,MAXORB
   10    IA(I)=(I*I-I)/2
      ENDIF
C
...
C
      MINPQ=MIN(NP,NQ)                                                  GCL0393
      MAXPQ=MAX(NP,NQ)                                                  GCL0393
      NP1=NP+1
      NP2=MAX(1,NP/2)                                                   GCL0393
...
C#      CALL MATOUT(VECL,THETA,NP,NP,NP)
  ...
  200 CONTINUE
      DO 210 I=1,MINPQ
         THETA(I)=MAX(THETA(I),ZERO)                                    GCL0393
         THETA(I)=MIN(THETA(I),1.D0)                                    GCL0393
...
C
      ...
      DO 550 K=1,MINPQ
         ...
         SK=SIN(XNOW*THETA(K))
         IF(DEBUG)WRITE(JOUT,
     .    '('' ROTATION ANGLE:'',F12.4)')SK*57.29578
         DO 540 I=1,N
...
C
  ...
  580 ROLD=XOLD*THETA(1)*57.29578
      ...
      IF(DEBUG)WRITE(JOUT,600) XOLD,EOLD*23.061,DEOLD,ROLD
     ...
     2,             XMIN,EMIN*23.061,DEMIN,RMIN
      ...
      WRITE(JOUT,610)
      DO 590 K=1,NPNTS
  590 WRITE(JOUT,620) K,X(K),F(K),DF(K)
      WRITE(JOUT,630)
      RETURN
  600 FORMAT(
