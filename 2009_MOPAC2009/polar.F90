...
!
          ...
          if (Abs(f(1,1)) > 1.d6) then
            write(iw,"(a)")" Calculation of polarizability failed (This part of MOPAC is fragile)"
...
!
!   where C_i are constants per atom, C_1 is a constant, stored in polvol(99),
!   and C_2 is a constant, stored in polvol(100)
!
!
    polarizability = average*a0**3
    if (polvol(99) > 1.d-4) then
