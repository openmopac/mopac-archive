...
!
        ...
        if (j < 10) then
          rewind (param_out)
          write (param_out,"(a)") "  module Parameters_for_PM7_C"        
          write (param_out,"(a)") "    use vast_kind_param, ONLY:  double  "
          write (param_out,"(a)") "    real(double), dimension(107) :: uss7, upp7, udd7, zs7, zp7, zd7, betas7, &"
          write (param_out,"(a)") "    betap7, betad7, gss7, gsp7, gpp7, gp27, hsp7, polvo7, poc_7, &"
          write (param_out,"(a)") "    zsn7, zpn7, zdn7, f0sd7, g2sd7, alp7"
          write (param_out,"(a)") "    real(double), dimension(107,4) :: gues71, gues72, gues73" 
          do i = 1, 107 
