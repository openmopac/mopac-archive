...
!
      ...
      site_no, method_pm7,  method_PM7_ts, sz, ss2, &
...
!-----------------------------------------------
      ...
      dip, dumy(3), pKa_unsorted(numat), hpress, distortion, rms
...
!          CAN BE USED BY THE PATH OPTION)
      ...
      write (iw, '(55X,''MOPAC2012 BETA VERSION(Version: '',a,a)') verson, ")"
...
!
      ...
      write (iwrite, '(55X,''MOPAC2012 BETA VERSION(Version: '',a,a)') verson, ")"
...
!----------------------------------------------- 
    ...
    use molkst_C, only : escf, moperr
    use chanel_C, only : iw
    implicit none
!
!  First, switch in parameters specific to the PM7-TS calculation.
!
  !  call Parameters_for_PM7_TS()
    call moldat(1)  
