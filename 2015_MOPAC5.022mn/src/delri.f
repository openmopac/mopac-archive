      SUBROUTINE DELRI(DG,NI,NJ,RR,DEL1,*)                              CSTP
...
*                                                                      *
************************************************************************
      COMMON  /MULTIP/  DD(120),QQ(120),BDD(120,3)
      ...
      QB=QQ(NJ)
C Added LF1110:
      IF (PMODS(4).AND.NI.EQ.9.AND.NJ.EQ.9.AND.HPUSED) THEN
        QA=0.0D0
        QB=0.0D0
      ENDIF
C End LF1110 addition.
C   HYDROGEN-HYDROGEN
