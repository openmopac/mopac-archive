      SUBROUTINE ROTATE1(NI,NJ,XI,XJ,W,KR,E1B,E2A,ENUC,CUTOFF,GTERM,*)  CSTP
C***********************************************************************
C
...
C     THIS CHANGE WAS MADE BASED ON AMSOL 7.1
C***********************************************************************
...
C     (S S/PX S)
            W(2)=RI(5)*X(1)*0.5D0
C     (S S/PX PX)
            W(3)=(RI(11)*XX11+RI(12)*YYZZ11)*0.25D0
C     (S S/PY S)
            W(4)=RI(5)*X(2)*0.5D0
C     (S S/PY PX)
            W(5)=(RI(11)*XX21+RI(12)*YYZZ21)*0.5D0
C     (S S/PY PY)
            W(6)=(RI(11)*XX22+RI(12)*YYZZ22)*0.25D0
C     (S S/PZ S)
            W(7)=RI(5)*X(3)*0.5D0
C     (S S/PZ PX)
            W(8)=(RI(11)*XX31+RI(12)*ZZ31)*0.5D0
C     (S S/PZ PY)
            W(9)=(RI(11)*XX32+RI(12)*ZZ32)*0.5D0
C     (S S/PZ PZ)
            W(10)=(RI(11)*XX33+RI(12)*ZZ33)*0.25D0
            KI = 10
         ENDIF
...
C     (PX S/PX PX)
     ...
     1           +RI(15)*(Y(1)*XY11+Z(1)*XZ11) )*0.5D0
C     (PX S/PY S)
...
C     (PX S/PY PY)
     ...
     1           +RI(15)*(Y(1)*XY22+Z(1)*XZ22))*0.5D0
C     (PX S/PZ S)
...
C     (PX S/PZ PZ)
     ...
     1           +RI(15)*(          Z(1)*XZ33))*0.5D0
C     (PX PX/S S)
               W(21)=(RI(3)*XX11+RI(4)*YYZZ11)*0.25D0
C     (PX PX/PX S)
               W(22)=(X(1)*(RI(8)*XX11+RI(9)*YYZZ11)
     1           +RI(10)*(Y(1)*XY11+Z(1)*XZ11) )*0.5D0
C     (PX PX/PX PX)
               W(23) =0.25D0*(
...
C     (PX PX/PY S)
     ...
     1           +RI(10)*(Y(2)*XY11+Z(2)*XZ11))*0.5D0
C     (PX PX/PY PX)
               W(25) =0.5D0*(
...
C     (PY S/PX PX)
     ...
     1           +RI(15)*(Y(2)*XY11+Z(2)*XZ11)) *0.5D0
C     (PY S/PY S)
...
C     (PY S/PY PY)
     ...
     1           +RI(15)*(Y(2)*XY22+Z(2)*XZ22) )*0.5D0
C     (PY S/PZ S)
...
C     (PY S/PZ PZ)
     ...
     1           +RI(15)*(         +Z(2)*XZ33))*0.5D0
C     (PY PX/S S)
               W(41)=(RI(3)*XX21+RI(4)*YYZZ21)*0.5D0
C     (PY PX/PX S)
...
C      (PY PX/PZ PZ)
     ...
     3     +RI(20)*XZ21*XZ33 )
C     (PY PY/S S)
               W(51)=(RI(3)*XX22+RI(4)*YYZZ22)*0.25D0
C     (PY PY/PX S)
               W(52)=(X(1)*(RI(8)*XX22+RI(9)*YYZZ22)
     1           +RI(10)*(Y(1)*XY22+Z(1)*XZ22) )*0.5D0
C      (PY PY/PX PX)
               W(53) =0.25D0*(
...
C     (PY PY/PY S)
     ...
     1           +RI(10)*(Y(2)*XY22+Z(2)*XZ22) )*0.5D0
C      (PY PY/PY PX)
               W(55) = 0.5D0*(
...
C     (PZ S/PZ PZ)
     ...
     1           +RI(15)*(         +Z(3)*XZ33)
C     (PZ PX/S S)
               W(71)=(RI(3)*XX31+RI(4)*ZZ31)*0.5D0
C     (PZ PX/PX S)
...
C      (PZ PX/PZ PZ)
     ...
     3     +RI(20)*XZ31*XZ33
C     (PZ PY/S S)
               W(81)=(RI(3)*XX32+RI(4)*ZZ32)*0.5D0
C     (PZ PY/PX S)
...
C       (PZ PY/PZ PZ)
     ...
     3     +RI(20)*XZ32*XZ33
C     (PZ PZ/S S)
               W(91)=(RI(3)*XX33+RI(4)*ZZ33)*0.25D0
C     (PZ PZ/PX S)
               W(92)=(X(1)*(RI(8)*XX33+RI(9)*ZZ33)
     1           +RI(10)*(          Z(1)*XZ33))*0.5D0
C       (PZ PZ/PX PX)
               W(93) = 0.25D0*(
...
C     (PX S/S S)
               W(2)=RI(2)*X(1)*0.5D0
C     (PX PX/S S)
               W(3)=(RI(3)*XX11+RI(4)*YYZZ11)*0.25D0
C     (PY S/S S)
               W(4)=RI(2)*X(2)*0.5D0
C     (PY PX/S S)
               W(5)=(RI(3)*XX21+RI(4)*YYZZ21)*0.5D0
C     (PY PY/S S)
               W(6)=(RI(3)*XX22+RI(4)*YYZZ22)*0.25D0
C     (PZ S/SS)
               W(7)=RI(2)*X(3) *0.5D0
C     (PZ PX/S S)
               W(8)=(RI(3)*XX31+RI(4)*ZZ31)*0.5D0
C     (PZ PY/S S)
               W(9)=(RI(3)*XX32+RI(4)*ZZ32)*0.5D0
C     (PZ PZ/S S)
               W(10)=(RI(3)*XX33+RI(4)*ZZ33)*0.25D0
               KI = 10
            END IF
         END IF
