...
!-----------------------------------------------
      ...
      & coord, w, set_a, set_b
      use molkst_C, only : numat, uhf, keywrd, temp_1, temp_2, numcal, itemp_1
...
!
  !    if (index(keywrd,"ENPART(") /= 0) then
      if (index(keywrd,"ENPARTx(") /= 0) then
...
!
            ...
            " Part ", nparts," self - energy:",sum, sum*fpc(9), temp_2, temp_1, temp_1 + temp_2, " Kcal/mol"
!
...
!
              ...
              numcal = numcal + 1
              call h_bond_correction(aa, .false.)
              write(iw,"(a,i1,a,i1,a,f11.4,' eV =',f13.3,' Kcal/mol', f10.3, f16.3,f15.3,a )") &
              " Parts ", nparts, " - ",l," interaction:",sum, sum*fpc(9), temp_2, temp_1, temp_1 + temp_2, " Kcal/mol"
              jl = ju + 1
            end do
            il = iu + 1
          end do
      ...
      write(iw,'(/,a, f10.3, a,f9.3,a,f10.3,a,/)') &
        ...
        temp_2," disp.:",temp_1," Tot:",temp_1 + temp_2," kcal/mol"
