...
!
      ...
      & coord, xparef, aicorr, tvec, labels, pa, p, pdiag
!
...
!
        ...
        if (method_pm7 .and. Si_O_H_present) atheat = atheat + Si_O_H_correction()            
        if(use_ref_geo) then
          stress = 0.d0
          do i = 1, numat
            do j = 1,3
