...
!
      USE molkst_C, only : gnorm, natoms, numat, nvar, numcal, nscf, id, &
        ...
        time0, atheat, errtxt, isok, mpack, gui, line, na1, site_no, refkey, &
...
!
      ...
      if (site_no == -1) then
        ...
        select case (l)
          ...
          case default
            write(iw,'(//10x,a)')" The demo version of MOPAC2012 is limited to systems with 1-12, 50-60, or 110-120 atoms"
