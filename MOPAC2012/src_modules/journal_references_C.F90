...
!...Created by Pacific-Sierra Research 77to90  4.4G  11:05:00  03/09/06   
      character (len=100), dimension(107) :: refmn, refpm6, refam, refpm3, &
        refmd, refrm1, refpm7
...
!
!  References for the Lanthanides
!
 data  refpm6(57)/ " La: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(58)/ " Ce: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(59)/ " Pr: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(60)/ " Nd: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(61)/ " Pm: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(62)/ " Sm: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(63)/ " Eu: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(64)/ " Gd: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(65)/ " Tb: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(66)/ " Dy: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(67)/ " Ho: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(68)/ " Er: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(69)/ " Tm: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(70)/ " Yb: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
 data  refpm6(71)/ " Lu: (PM6): R.O.Freire and A.M.Simas, to be submitted                                        "/
!
!
!
      data  refmn(  1)  /  &
...
!
     ...
     ' Lu: (PM3): R.O. FREIRE, ET AL, J. PHYS. CHEM. A 110 (17) (2006) 5897. '/
      ...
      &        '/
      data refpm7 / 107* &
       ' PM7 development complete. No journal reference available at present.   &
      &        '/
