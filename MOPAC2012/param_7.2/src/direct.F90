...
!
    ...
    moperr,  atheat, norbs, is_PARAM, id, rjkab1, keywrd, line
...
!-----------------------------------------------------------------------
  ...
  !***********************************************************************
    ...
    if(numvar == 0)open (unit=55, file="CALCD.TXT", status="UNKNOWN",iostat = loop)
    do loop = 1, nmols
      molnum = molnum + 1
      tleft = 10000.d0
    !
...
!
  ...
  ! end if
   write(ifiles_8,"(/2x,A33,F14.4,3F14.2,10(/7x,7f14.2))") &
